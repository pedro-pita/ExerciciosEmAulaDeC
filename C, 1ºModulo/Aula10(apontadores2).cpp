...
#include <string.h>
int main(){  
	/*Atribuição: ponteiros podem apenas receber o endereço 8   de variaveis do memso tipo que o ponteiro 9*/  
	...
	printf("x = %d\n",x);
	/* O valor de um endereço armazenado por um ponteiro pode ser somado e subtraido (valores Inteiros)*/
	printf("p = %d\n",p);
	...
	p -= 2;// 2*4 = 8
	 ...
	 printf("\nDepois-> \np = %d\nc = %d",p,c);
	 /* Comparação de Ponteiros (==,!=,>,<,<=,>=) Estas verificaçõe indicam se o Ponteiros apontam para o mesmo local da memoria 41*/
	 int *w,*w1, q, o=12; 
	 w = &o;
	 w1 = &o;
	 printf("\nw = %d\n",w);
